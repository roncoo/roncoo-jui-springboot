...
<div class="pageFormContent" layoutH="80" style="padding:20px;">
	<h2>项目介绍：</h2>
	<div class="unit">后台框架：Spring Boot v1.5.7</div>
	<div class="unit">前端框架：JUI v1.5.2</div>
    <br/>
	<div class="divider"></div>
    <br/>
	<h2>更新日志：</h2>
	<div class="unit">2017-11-13 集成roncoo-spring-boot-starter-shiro</div>
	<div class="unit">2017-05-17 集成roncoo-spring-boot-starter-druid</div>
	...
	<br/>
	<h2>课程推荐：</h2>
	<div class="unit"><span>Spring Boot全集 <a href="http://www.roncoo.com/course/view/c99516ea604d4053908c1768d6deee3d" target="_blank">http://www.roncoo.com/course/view/c99516ea604d4053908c1768d6deee3d</a></span></div>
    <br/>
	<div class="divider"></div>
    <br/>
    <h2>云服务器推荐：</h2>
	<div class="unit"><span>千铭云：<a href="https://www.chanmir.cn/?u=6C53A9" target="_blank">https://www.chanmir.cn/?u=6C53A9</a></span></div>
</div>						
