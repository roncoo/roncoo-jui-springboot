        ...
        <table class="list" width="100%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a title="查看" target="dialog" href="${base}/admin/rcDataDictionary/view?id=${bean.id}" class="btnView">查看 </a>
                        <a title="编辑" target="dialog" href="${base}/admin/rcDataDictionary/edit?id=${bean.id}" class="btnEdit">修改 </a>
                        <a title="确定要删除吗？" target="ajaxTodo" href="${base}/admin/rcDataDictionary/delete?id=${bean.id}" class="btnDel">删除</a>
                    </td>
                </tr>
                </#list>
                </#if>
