...
<div class="pageContent">
    <div class="panelBar">
        <ul class="toolBar">
            ...
            <li><a class="add" href="${base}/admin/rcDataDictionaryList/add" target="dialog"><span>添加</span></a></li>
            <li class="line">line</li>
        </ul>
    </div>
    <div id="w_list_print">
        <table class="list" width="100%" targetType="navTab" asc="asc" desc="desc" layoutH="116">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a title="查看" target="dialog" href="${base}/admin/rcDataDictionaryList/view?id=${bean.id}" class="btnView">查看 </a>
                        <a title="编辑" target="dialog" href="${base}/admin/rcDataDictionaryList/edit?id=${bean.id}" class="btnEdit">修改 </a>
