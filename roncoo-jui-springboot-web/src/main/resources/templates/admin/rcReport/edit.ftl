...
<div class="pageContent">
	<form action="${base}/admin/rcReport/update" method="post" class="pageForm required-validate" onsubmit="return validateCallback(this, dialogAjaxDone);>
		<div class="pageFormContent" layoutH="58">
    		...
    		<p>
                <label>用户QQ：</label>
                <input type="text" name="userEmail" value="${bean.userEmail}" placeholder="用户QQ" size="20">
            </p>
    		<p>
                <label>用户昵称：</label>
