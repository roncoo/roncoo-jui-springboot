...
public class DataDictionaryController extends BaseController {
	...
	private static final String NAVTABID = "";
	...
	public void list(@RequestParam(defaultValue = "1") int currentPage, @RequestParam(defaultValue = "20") int numPerPage, @ModelAttribute RcDataDictionary rcDataDictionary, ModelMap modelMap) {
		Result<Page<RcDataDictionary>> result = biz.listForPage(currentPage, numPerPage, rcDataDictionary);
		if (result.isStatus()) {
